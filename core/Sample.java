...
public class Sample {
	...
	public static void main(String[] args) {
		...
		//sort-cut Main + Control + Space
		//main is a method or function 
		//static is used for memory management 
		//void is nothing return but it is return itself 
		
         System.out.println("Welcome to automation.");
         System.out.println("We can learn automation.");
         
       //sort-cut Syso + Control + Space 
       //out  have input, output, error
